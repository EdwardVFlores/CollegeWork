// File: IntArrayBag.java from the package Homework4
// Package contains IntArrayBag.java, KeyedBag.java and Homework4MainClass.java
package DataStructures.Homework4;

/******************************************************************************
 * An IntArrayBag is a collection of int numbers. The same number may appear
 * multiple times in a bag.
 *
 * @note (1) The capacity of one of these bags can change after it's created,
 ...
 *       <p>
 *       (3) Because of the slow linear algorithms of this class, large bags
 *       will have poor performance.
 *
 * @see <A HREF="../../../../edu/colorado/collections/IntArrayBag.java"> Java
...
public class IntArrayBag implements Cloneable {
    ...
    /**
     * Initialize an empty bag with an initial capacity of 10. Note that the addItem
     ...
     * @postcondition This bag is empty and has the given initial capacity.
    ...
    /**
     * Add a new element to this bag. If the new element would take this bag beyond
     ...
     *       the bag to fail with an arithmetic overflow.
     **/
    ...
    /**
     * Add new elements to this bag. If the new elements would take this bag beyond
     * its current capacity, then the capacity is increased before adding the new
     * elements.
     * 
     * @param elements (a variable-arity argument) one or more new elements that are
     *                 being inserted
     * @postcondition A new copy of the element has been added to this bag.
     * @exception OutOfMemoryError Indicates insufficient memory for increasing the
     *                             bag's capacity.
     ...
     *                                 size of the bag.
     * @note An attempt to increase the capacity beyond Integer.MAX_VALUE will cause
     *       an arithmetic overflow that will cause the bag to fail. Such large
     *       collections should use a different bag implementation.
     **/
    ...
    /**
     * Accessor method to get the current capacity of this bag. The add method works
     ...
     * @return If target was found in the bag, then one copy of target has been
    ...
    /**
     * Reduce the current capacity of this bag to its actual size (i.e., the number
     ...
     *                                 bag.
     * @note An attempt to create a bag with a capacity beyond Integer.MAX_VALUE
     *       will cause an arithmetic overflow that will cause the bag to fail. Such
     *       large collections should use a different bag implementation.
     **/
