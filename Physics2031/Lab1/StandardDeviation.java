...
public class StandardDeviation {
    public static void main(String[] args) {
        ...
        // int[] nums = new int[] {11,15,39,40,66,95,95,114,96,77,44,36,25}; // class
        // values
        // int[] nums = new int[] {1, 2, 5, 10, 18, 21, 16, 34, 20, 13, 5, 4, 2}; //
        // group 1 values
        // int[] nums = new int[] {1, 1, 7, 8, 18, 17, 21, 18, 14, 11, 18, 14,4}; //
        // group 2 values
        // int[] nums = new int[] {2, 4, 13, 5, 14, 11, 27, 24, 24, 15, 6, 3, 2}; //
        // group 3 values
        // int[] nums = new int[] {3, 2, 4, 9, 8, 23, 12, 25, 17, 23, 6, 8, 10}; //
        // group 4 values
        ...
        for (int i = 1; i < nums.length + 1; i++)
            Variance += Math.pow((i - mean), 2) * nums[i - 1];
        ...
        double sumOfChiSquaredValues = 0;
        for (double i : chiSquaredValues)
            sumOfChiSquaredValues += i;
        System.out.println("\nChi Squared Value: ");
        System.out.println(sumOfChiSquaredValues);
        System.out.println("\nReduced Chi Squared Value:");

        /*
         * for(int i = 0; i < nums.length; i++){ //if(i%2==0)
         * //System.out.printf("Bin #%d: %.2f (%s)\n",i+1,chiSquaredValues[i]/10,
         * chiSquaredValues[i]/10 > 1?"No":"Yes"); }
         */
        System.out.printf("%f Supported? %s", sumOfChiSquaredValues / 10,
                sumOfChiSquaredValues / 10 > 1 ? "No" : "Yes");
    }
}
